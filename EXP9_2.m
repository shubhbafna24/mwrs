...
%% PART 2 : 
% Perform a Monte Carlo simulation to estimate and plot the error probability of a binary antipodal (BPSK) 
% signaling communication system in Rayleigh fading.
